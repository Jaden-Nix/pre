...
app.post('/api/admin/create-quick-play-market', requireAdmin, async (req, res) => {
    ...
    try {
        ...
        // Call createMarket with 7 parameters (as the deployed contract requires)
        // Use minimal liquidity: 0.001 BNB split 50/50
        const liquidityBnbWei = ethers.utils.parseEther('0.001');
        const halfLiquidityBnb = liquidityBnbWei.div(2);
        const halfLiquidityPred = ethers.utils.parseEther('0.5').div(2);
        ...
        const tx = await predictionMarketContract.createMarket(
            ...
            halfLiquidityPred,     // _initialYesPred
            halfLiquidityPred,     // _initialNoPred
            { value: liquidityBnbWei, gasLimit: 300000 }
        );
