export const PREDICTION_MARKET_ADDRESS = '0xc0c9F3ff25517E7fF83d8be747F544c8595ADEDB' as const;
...
export const PREDICTION_MARKET_ABI = [
  ...
  },
  {
    ...
    "inputs": [
      ...
      {"indexed": false, "internalType": "bool", "name": "pick", "type": "bool"}
    ],
    "name": "BetPlaced",
    "type": "event"
  },
  ...
  },
  {
    ...
    "inputs": [
      {"indexed": true, "internalType": "uint256", "name": "marketId", "type": "uint256"},
      {"indexed": true, "internalType": "address", "name": "disputor", "type": "address"}
    ],
    "name": "MarketDisputed",
    "type": "event"
  },
    ...
    "outputs": [
      {
        "components": [
          ...
          {"internalType": "uint256", "name": "resolutionSubmittedAt", "type": "uint256"},
          {"internalType": "bool", "name": "autoPayoutTriggered", "type": "bool"}
        ],
    ...
    "outputs": [
      {
        "components": [
          ...
          {"internalType": "bool", "name": "pick", "type": "bool"},
  ...
  },
  {
    "inputs": [
      {"internalType": "uint256", "name": "_marketId", "type": "uint256"},
      {"internalType": "bool", "name": "_pick", "type": "bool"}
    ],
    "name": "placeBet",
    "outputs": [],
    "stateMutability": "payable",
